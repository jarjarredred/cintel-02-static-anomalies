"""
anomaly_detector_jarred.py - Project script (example).
...
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "anomalies_jarred2.csv"
...
def main() -> None:
    ...
    MAX_REASONABLE_X_VALUE: Final[float] = 13.0

    # y is height in inches, so maybe 6 feet (72 inches) is a reasonable upper limit
    MAX_REASONABLE_Y_VALUE: Final[float] = 62.0
